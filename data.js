...
const WM_GROUPS = [
  ...
  },
  {
    ...
    games: [
      ...
      { id: "F3", date: "2026-06-20", time: "19:00", home: "Japan", away: "Tunesien", venue: "Dallas" },
  ...
  },
  {
    ...
    games: [
      ...
      { id: "G3", date: "2026-06-21", time: "19:00", home: "Ägypten", away: "Neuseeland", venue: "Atlanta" },
      { id: "G4", date: "2026-06-21", time: "22:00", home: "Belgien", away: "IR Iran", venue: "Miami" },
      { id: "G5", date: "2026-06-26", time: "02:00", home: "Ägypten", away: "Belgien", venue: "Boston" },
      { id: "G6", date: "2026-06-26", time: "02:00", home: "Neuseeland", away: "IR Iran", venue: "Houston" },
    ]
  },
  {
    name: "Gruppe H",
    ...
    games: [
      ...
      { id: "H4", date: "2026-06-21", time: "21:00", home: "Kap Verde", away: "Uruguay", venue: "Boston" },
      { id: "H5", date: "2026-06-26", time: "21:00", home: "Spanien", away: "Uruguay", venue: "New York/NJ" },
      { id: "H6", date: "2026-06-26", time: "21:00", home: "Kap Verde", away: "Saudi-Arabien", venue: "Philadelphia" },
    ]
  },
  {
    name: "Gruppe I",
  ...
  },
  {
    ...
    games: [
      ...
      { id: "K3", date: "2026-06-23", time: "00:00", home: "Portugal", away: "Usbekistan", venue: "San Francisco" },
      { id: "K4", date: "2026-06-23", time: "03:00", home: "Kolumbien", away: "DR Kongo", venue: "Miami" },
      { id: "K5", date: "2026-06-27", time: "22:00", home: "Kolumbien", away: "Portugal", venue: "Atlanta" },
      { id: "K6", date: "2026-06-27", time: "22:00", home: "DR Kongo", away: "Usbekistan", venue: "Toronto" },
    ]
  },
  {
    name: "Gruppe L",
    ...
    games: [
      ...
      { id: "L3", date: "2026-06-23", time: "19:00", home: "England", away: "Ghana", venue: "Seattle" },
      { id: "L4", date: "2026-06-23", time: "22:00", home: "Panama", away: "Kroatien", venue: "Houston" },
      { id: "L5", date: "2026-06-27", time: "19:00", home: "England", away: "Panama", venue: "Los Angeles" },
      { id: "L6", date: "2026-06-27", time: "19:00", home: "Kroatien", away: "Ghana", venue: "Atlanta" },
    ]
  }
];

// Alle Gruppenspiele als flache Liste
const ALL_GROUP_GAMES = WM_GROUPS.flatMap(g => g.games.map(game => ({ ...game, group: g.name })));

// KO-Runden Struktur
// Sechzehntelfinale: 16 Spiele (28 Juni - 3 Juli)
// Achtelfinale: 8 Spiele (4-7 Juli)
// Viertelfinale: 4 Spiele (9-11 Juli)
// Halbfinale: 2 Spiele (14-15 Juli)
// Spiel um Platz 3: 1 Spiel (18 Juli)
// Finale: 1 Spiel (19 Juli)
...
const KO_ROUNDS = [
  {
    ...
    games: [
      ...
      { id: "R16_3",  date: "2026-06-29", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 3" },
      { id: "R16_4",  date: "2026-06-29", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 4" },
      { id: "R16_5",  date: "2026-06-30", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 5" },
      { id: "R16_6",  date: "2026-06-30", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 6" },
      { id: "R16_7",  date: "2026-07-01", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 7" },
      { id: "R16_8",  date: "2026-07-01", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 8" },
      { id: "R16_9",  date: "2026-07-02", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 9" },
      { id: "R16_10", date: "2026-07-02", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 10" },
      { id: "R16_11", date: "2026-07-03", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 11" },
      { id: "R16_12", date: "2026-07-03", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 12" },
      { id: "R16_13", date: "2026-07-03", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 13" },
      { id: "R16_14", date: "2026-07-03", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 14" },
      { id: "R16_15", date: "2026-07-03", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 15" },
      { id: "R16_16", date: "2026-07-03", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 16" },
    ]
  },
  {
    id: "qf4",
    name: "Achtelfinale",
    games: [
      { id: "AF_1", date: "2026-07-04", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 1" },
      { id: "AF_2", date: "2026-07-04", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 2" },
      { id: "AF_3", date: "2026-07-05", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 3" },
      { id: "AF_4", date: "2026-07-05", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 4" },
      { id: "AF_5", date: "2026-07-06", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 5" },
      { id: "AF_6", date: "2026-07-06", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 6" },
      { id: "AF_7", date: "2026-07-07", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 7" },
      { id: "AF_8", date: "2026-07-07", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 8" },
    ]
  },
  {
    id: "sf",
    name: "Viertelfinale",
    games: [
      { id: "VF_1", date: "2026-07-09", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 1" },
      { id: "VF_2", date: "2026-07-10", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 2" },
      { id: "VF_3", date: "2026-07-11", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 3" },
      { id: "VF_4", date: "2026-07-11", time: "21:00", home: "TBD", away: "TBD", venue: "TBD", label: "Spiel 4" },
    ]
  },
  {
    id: "hf",
  ...
  },
  {
    ...
    games: [
      { id: "P3_1", date: "2026-07-18", time: "21:00", home: "TBD", away: "TBD", venue: "Miami", label: "Spiel um Platz 3" },
    ]
  },
  {
    id: "fi",
